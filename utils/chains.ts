...
console.log('Chain configuration:', {
  ...
  proxyApi: DefaultChain.proxyApi,
});
...
export default [
  ...
  },
  {
    ...
    lightIconUrl: '/icons/bsc-icon-dark.svg',
    darkIconUrl: '/icons/bsc-icon-light.svg',
    reservoirBaseUrl: "https://api-opbnb.reservoir.tools/",
  ...
  },
  {
    ...
    reservoirBaseUrl: "https://api-apex.reservoir.tools/",
  ...
  },
  {
    ...
    reservoirBaseUrl: "https://api-astar-zkevm.reservoir.tools/",
